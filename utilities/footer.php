    ...
    <div class="row p-0 m-0 mt-5" id="footer">
        ...
        <div class="col-md-3">
            <ul class="application">
                ...
                <li><a href="#" target="_blank"><img src="../assets/img/footer/appStore.png" alt="appStore"></a><li>
                <li><a href="#" target="_blank"><img src="../assets/img/footer/googlePlay.png" alt="googlePlay" class="mt-2"></a></li>
            </ul>
        </div>
        <p><a href="#" title="legalNotice">Mentions légales</a> - <a href="#">Conditions générales d'utilisations</a></p>
    </div>
