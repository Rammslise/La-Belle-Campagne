...
if (isset($_POST['submitClient'])) {
    ...
    $client->password = isset($_POST['password']) ? htmlspecialchars($_POST['password']) : '';
    $client->confirmPassword = isset($_POST['confirmPassword']) ? htmlspecialchars($_POST['confirmPassword']) : '';
    ...
    if (empty($client->formErrors)) {
        ...
        // Hashage du MDP pour une sécurité supplémentaire.
...
//            header('Location: ../connexion.php?id=' . $profile->id);
//            exit();
//        } else {
...
?>
<!--elseif (password_verify($clientPassword, $clientConfirmPassword))-->
