...
--
-- Hôte : localhost:3306
-- Généré le :  lun. 09 mars 2020 à 10:57
...
(6, 'mamat', 'mathieu.lelievre@orange.net', '$2y$10$n9/mOLpCo3PHkRXnnp8XbOQ8yWSDsxhEK0xow54Ys8qnjnLoXZaSC', 2),
(7, 'alex02', 'alexandrie.jo@wanadoo.fr', '$2y$10$rlrX.Lsr42.AdKFa9JH8E.xGc0YJigwdJjGJMczp3sSo7OIo7AKpm', 2),
(8, 'cécé', 'celina.S@wanadoo.fr', '$2y$10$RD9VpKmbnGPZQhyazUuu/e9iwYagtSruAcj/Wpb9gAuWnWEgqPc4K', 2),
(12, 'Mel', 'm.parizeau@wanadoo.fr', '$2y$10$i.vtIzoblzpANaUgesXSMeLZJdJgwJlqSVxKMivzpQ..S1mbLNfVq', 2),
(13, 'lundy', 'l.genereux@wanadoo.fr', '$2y$10$rwLrjfrlDKaRYc56.CnTlOn.kISFrY4OXRE3yZY1rJ04baxXNaJLy', 2),
(14, 'sisi', 's.chaussee@wanadoo.fr', '$2y$10$hWMTWEakaL8wDoOtVddVc.QBR40chjk1i3KXlDrJLzRplj3YM7veO', 2),
(15, 'gerM', 'g.doucet@wanadoo.fr', '$2y$10$77WwMJx7n4y3rSmFmuUyYunr.NWXKdix2DHSbdHcLG4NEVmNUB1Ta', 2),
(16, 'nath', 'n.abril@wanadoo.fr', '$2y$10$PWowtg7MFtctNBNnm5yYGOgWjD3ZSHPt71LO.cAWO0ZcqvnXVICSK', 2),
(17, 'chEr', 'c.hebert@wanadoo.fr', '$2y$10$V/m0D2f0dIJHH2grcwxrP.Rucf2JsIHmOAWDk4rXAueI.22Owk50C', 2),
(18, 'mimile', 'e.grivois@wanadoo.fr', '$2y$10$ym78mtR20Pb1VcuE9Tof0Or7q0osvIJjIEFCF0fDmkJd0A223Rqde', 2),
(19, 'Killian', 'killian@gmail.com', '$2y$10$idaCiczJ9BdiuexlQ/tns.xLMzCVV3n6TC6vRIl3ejxfvOn.0s45a', 2),
(20, 'lilise', 'e.pery@laposte.net', '$2y$10$MSRqvWI2srYG7bOCpZ5gPe2HPzuzwxSW/8StDAs0cBZwRj8cETnum', 1);
...
INSERT INTO `7ie1z_producers` (`id`, `mail`, `password`, `lastname`, `firstname`, `companyName`, `city`, `file`, `description`, `id_7ie1z_roles`) VALUES
...
ALTER TABLE `7ie1z_items`
  ...
  ADD KEY `7ie1z_items_7ie1z_clients0_FK` (`id_7ie1z_clients`),
  ADD KEY `7ie1z_items_7ie1z_orders1_FK` (`id_7ie1z_orders`);
...
--
ALTER TABLE `7ie1z_items`
  ADD CONSTRAINT `7ie1z_items_7ie1z_clients0_FK` FOREIGN KEY (`id_7ie1z_clients`) REFERENCES `7ie1z_clients` (`id`),
  ADD CONSTRAINT `7ie1z_items_7ie1z_orders1_FK` FOREIGN KEY (`id_7ie1z_orders`) REFERENCES `7ie1z_orders` (`id`),
