<!--Partie Header avec le fichier Navbar intégré -->
<?php require 'utilities/header.php'; ?>

<body>
    <h3 class="p-2 mb-1 text-center ">Dans l'actualité</h3>
    <div class="row">
        <div class="col-4">
        ...
        <div class="col-4">
            <div id="homeCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="assets/img/body/publicity.jpg" class="d-block w-100" alt="publicity">
                    </div>
                </div>
            </div>
        </div>
        <!-- Hover sur une image-->
        <div class="col-4 content-details fadeIn-bottom">
                <img src="assets/img/body/cow.jpeg" id="cowPhoto" alt="cowPhoto" />
                <div class="mask">
                    <h2>Salon de l'agriculture</h2>
                    <p>Du 22 février au 1 mars 2020.</p>
